<div class="modal-md modal-dialog" >
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 style="overflow-x: auto;" class="modal-title" >ANULAR LIQUIDACION PARA  <?=$_POST['nombre']?></h4>

    </div>


    <div class="modal-body">
      <form  onsubmit="fn_cancelar_desglose($('#detalle').val(),
                                $('#id_soli_fk').val())
          ...
          <br>
            ...
            <div class="row">
              <div class="form-group">
                <input type="submit" id="btn_can_desglose" class="btn btn-success" href="javascript:;" value="ANULAR DESGLOSE"/>
