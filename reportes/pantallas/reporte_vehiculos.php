...
<body>
  ...
  <div class="panel-body">
    <?php $h1 = "Reporte de Vehiculos"; echo '<h4 class="page-header"  style="text-transform: uppercase; font-weight: bold;" ><span class="glyphicon glyphicon-list-alt"></span> Reporte de Vehiculos</h4>';?>
   ...
   <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <form class="form-inline" role="form" autocomplete="off">
                  <div class="col-md-3">
                      <select type="text" id="cbx_busqueda_vehiculo" class="form-control " data-toggle="tooltip" data-placement="top" title="" data-original-title="Filtrar">
                        <option value="">Seleccione busqueda</option>
                          <option value="ult_reg">Últimos registros</option>
                          <option value="veh_utulizado">Vehiculos más utilizados</option>
                    ...
                    <div class="form-group col-md-6" id="div-fechas" style="display:none">
                        ...
                        <a class="fa fa-search btn btn-info ver_detalle" id="btn_buscar_fechas_vehiculo"></a>
                    ...
                    <div class="form-group col-md-4" id="div-kilometraje" style="display:none;">
                        Cantidad:   <input onkeypress="return validarNumeros(event)" maxlength="3"  style="font-weight: bold; " type="text" class="form-control"  id="bs-kilometraje" >
                ...
                <div class="form-group col-md-2 "  id="div-btn-generar" style="display:none">
                      ...
                      onclick="fn_generar_reporte_vehiculo();return false;">
                </div>
            </form>
        </div>
    </div>
