...
$tabla = new reportes();
$tabla_depen_c = $tabla->traer_giras_can_dependencia($_POST['depen']);
 ?>
 <div class="panel-body">



<?php if ($tabla_depen_c->num_rows){?>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="categorias-dt">
                <thead>
                    <tr>
                      ...
                      <th><center>Solicitudes canceladas</center></th>
                    </tr>
                </thead>
                <tbody>
  <!-- SE RECORREN LOS REGISTROS DE LA BASE DE DATOS-->
                  <?php
                  $i=0;
                  while($row = mysqli_fetch_assoc($tabla_depen_c)){?>
                            <tr >
