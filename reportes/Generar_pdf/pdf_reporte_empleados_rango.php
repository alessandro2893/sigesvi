...
$tabla = new reportes();
$empleados_rango = $tabla->traer_empleado_por_rango($_GET['desde'], $_GET['hasta']);
...
$i=0;
while($row = mysqli_fetch_assoc($empleados_rango)){
    $i+1;$i++;
    $content.='
    <tr class="second">
    ...
    $content .='</table>';
        ...
        // $content="";
      	...
      	$pdf->lastPage();
      	$pdf->output('reporte_empleados_por_rango_de_fechas.pdf','I');
