...
$tabla = new reportes();
$tabla_vehiculo_rango = $tabla->traer_vehiculos_por_rango($_GET['desde'], $_GET['hasta']);
...
$i=0;
while($row = mysqli_fetch_assoc($tabla_vehiculo_rango)){
    $i+1;$i++;
    $content.='
    <tr class="second">
    ...
    $content .='</table>';
        ...
        // $content="";
      	...
      	$pdf->lastPage();
      	$pdf->output('reporte_vehiculos_por_rango_de_fechas.pdf','I');
