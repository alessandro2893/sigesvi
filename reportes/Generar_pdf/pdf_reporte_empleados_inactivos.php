...
$tabla = new reportes();
$empleado_activo = $tabla->traer_tabla_empleados_activo($_GET['estado']);
...
<table class="first" cellpadding="1" cellspacing="2">
 <tr class="first">
  ...
  <td width="28%" align="center" ><b>Nombre</b></td>
  <td width="12%"align="center"><b>Identidad</b></td>
  <td align="center"><b>Cargo</b></td>
  <td align="center"><b>Dependencia</b></td>
  <td width="10%" align="center"><b>Categoria</b></td>
  <td width="8%" align="center"><b>Estado</b></td>
  <td width="14%" align="center"><b>Motivo inactividad</b></td>
 </tr>
...
$i=0;
while($row = mysqli_fetch_assoc($empleado_activo)){
    $i+1;$i++;
    $content.='
    <tr class="second">
      <td align="center">'.$i.'</td>
      <td >'.$row['nombre'].'</td>
      <td align="center">'.$row['tarjeta_identidad'].'</td>
      ...
      <td align="center">'.$row['motivo_inactividad'].'</td>
    </tr>';
    };
    ...
    $content .='</table>';
        ...
        $pdf->Cell(60, 8, 'Registro de empleados '.$_GET['estado'].'s', 0);
        ...
        // $content="";
      	...
      	$pdf->lastPage();
      	$pdf->output('reporte_empleados_inactivos.pdf','I');
