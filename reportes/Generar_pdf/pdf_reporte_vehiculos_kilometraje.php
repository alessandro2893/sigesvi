...
$tabla = new reportes();
$tabla_kilometraje = $tabla->traer_tabla_vehiculos_kilometraje($_GET['kilometraje']);
...
<table class="first" cellpadding="1" cellspacing="2">
 <tr class="first">
  ...
  <td width="16%" align="center"><b>Marca</b></td>
  <td width="18%" align="center"><b>Kilometraje</b></td>
 </tr>
...
$i=0;
while($row = mysqli_fetch_assoc($tabla_kilometraje)){
    $i+1;$i++;
    $content.='
    <tr class="second">
      ...
      <td align="center">'.$row['kilometraje'].'</td>
    </tr>';
    };
    ...
    $content .='</table>';
        ...
        $pdf->Cell(70, 8, 'Vehículos Más Utilizados: '.$_GET['kilometraje'], 0);
        ...
        // $content="";
      	...
      	$pdf->lastPage();
      	$pdf->output('reporte_vehiculos_mas_utilizados.pdf','I');
