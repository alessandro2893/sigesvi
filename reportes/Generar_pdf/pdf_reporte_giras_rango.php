...
$tabla = new reportes();
$giras_rango = $tabla->traer_giras_por_rango($_GET['desde'], $_GET['hasta']);
...
<table class="first" cellpadding="1" cellspacing="2">
 <tr class="first">
  ...
  <td width="20%"align="center"><b>Lugar de la gira</b></td>
  <td align="center"><b>Proposito</b></td>
  <td align="center"><b>Fecha salida</b></td>
  <td width="15%" align="center"><b>Fecha retorno</b></td>
  <td width="15%" align="center"><b>Fecha solicitud</b></td>
 </tr>
...
$i=0;
while($row = mysqli_fetch_assoc($giras_rango)){
    $i+1;$i++;
    $content.='
    <tr class="second">
      <td align="center">'.$i.'</td>
      <td align="center">'.$row['nombre'].'</td>
      <td align="center">'.$row['lugar_gira'].'</td>
      <td align="center">'.$row['proposito'].'</td>
      <td align="center">'.$row['fecha_salida'].'</td>
      <td align="center">'.$row['fecha_retorno'].'</td>
    ...
    $content .='</table>';
        ...
        $pdf->Cell(70, 8, 'Desde: '.$_GET['desde']. ' Hasta: '.$_GET['hasta'], 0);
        ...
        // $content="";
      	...
      	$pdf->lastPage();
      	$pdf->output('reporte_solicitudes_por_rango_de_fechas.pdf','I');
