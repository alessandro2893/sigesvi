...
$tabla = new reportes();
$giras_anio = $tabla->traer_giras_por_anno($_GET['anio']);
...
<table class="first" cellpadding="1" cellspacing="2">
 <tr class="first">
  ...
  <td width="24%"align="center"><b>Lugar de la gira</b></td>
  <td align="center"><b>Proposito</b></td>
  <td align="center"><b>Fecha salida</b></td>
  <td width="8%" align="center"><b>Fecha retorno</b></td>
 </tr>
...
while($row = mysqli_fetch_assoc($giras_anio)){
    ...
    $content .='</table>';
        ...
        // $content="";
      	...
      	$pdf->lastPage();
      	$pdf->output('reporte_solicitudes_por_anio.pdf','I');
